...
#ifndef HDDAQ__HULSCALER_UNPACKER_HH
#define HDDAQ__HULSCALER_UNPACKER_HH
...
class HulScaler : public DAQNode, public Uncopyable<HulScaler>
{
public:
  ...
  static const uint32_t k_scaler_data_mask  = 0xfffffff;
  static const uint32_t k_scaler_data_shift = 0U;
...
public:
  HulScaler( const unpacker_type& type );
  virtual ~HulScaler();
